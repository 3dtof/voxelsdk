...
export PATH="$PWD/Voxel/Debug":$PATH
...
export PATH="/C/Program Files/VTK/bin":$PATH
export VOXEL_FW_PATH="$PWD/TI3DToF/Debug"
export VOXEL_CONF_PATH="$PWD/TI3DToF/Debug"
export VOXEL_LIB_PATH="$PWD/TI3DToF/Debug"
