...
if(LINUX)
  ...
  function(create_cpack_config name ver)
    ...
    set(CPACK_PACKAGE_FILE_NAME "${name}_${ver}_${ARCH}")
    set(CPACK_OUTPUT_CONFIG_FILE "${CMAKE_BINARY_DIR}/CPackConfig-${name}.cmake")
    include(CPack)
  endfunction(create_cpack_config)


  get_distribution_codename(LINUX_CODENAME)
  set(VOXEL_DEBIAN_VERSION ${VOXEL_VERSION}-${VOXEL_DEBIAN_REVISION}${LINUX_CODENAME})
endif()
