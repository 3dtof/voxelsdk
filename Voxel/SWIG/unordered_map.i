...
%include <std_pair.i>
%include "standard_container.i"

%define %std_unordered_map_methods_common(unordered_map...)
  %standard_container_methods(unordered_map);
...
namespace std {
  ...
  public:
    ...
    %fragment(SWIG_Traits_frag(std::unordered_map<_Key, _Tp, _Hash, _Compare, _Alloc >), "header",
              fragment=SWIG_Traits_frag(std::pair<_Key, _Tp >),
              fragment="StdMapTraits") {
      namespace swig {
        template <>  struct traits<std::unordered_map<_Key, _Tp, _Hash, _Compare, _Alloc > > {
          typedef pointer_category category;
          static const char* type_name() {
    ...
    %typemap_traits_ptr(SWIG_TYPECHECK_MAP, std::unordered_map<_Key, _Tp, _Hash, _Compare, _Alloc >);

    //unordered_map();

#ifdef %swig_unordered_map_methods
    // Add swig/language extra methods
    %swig_unordered_map_methods(std::unordered_map<_Key, _Tp, _Hash, _Compare, _Alloc >);
#endif
